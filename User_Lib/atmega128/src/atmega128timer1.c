...
// for more information read data sheet.
{
	...
	tc1_instance()->tccr1a.reg &= ~((3 << COM1A0) | (3 << COM1B0) | (3 << COM1C0));
	tc1_instance()->timsk.reg &= ~((1 << TICIE1) | (1 << OCIE1A) | (1 << OCIE1B) | (1 << TOIE1));
	tc1_instance()->etimsk.reg &= ~(1 << OCIE1C);
	switch(interrupt){ // ICP1  -->  PD4
		case 0:
		break;
		case 1:
			tc1_instance()->timsk.reg |= (1 << TOIE1);
			cpu_instance()->sreg.reg |= 1 << GLOBAL_INTERRUPT_ENABLE;
		break;
		case 2:
			tc1_instance()->timsk.reg |= (1 << OCIE1A);
			cpu_instance()->sreg.reg |= 1 << GLOBAL_INTERRUPT_ENABLE;
		break;
		case 3:
			tc1_instance()->timsk.reg |= (1 << OCIE1B);
			cpu_instance()->sreg.reg |= 1 << GLOBAL_INTERRUPT_ENABLE;
		break;
		case 4:
			tc1_instance()->etimsk.reg |= (1 << OCIE1C);
		...
		break;
		case 5:
			tc1_instance()->timsk.reg |= (1 << TICIE1);
			cpu_instance()->sreg.reg |= 1 << GLOBAL_INTERRUPT_ENABLE;
		break;
		case 6:
			tc1_instance()->timsk.reg |= (1 << OCIE1A) | (1 << TOIE1);
			cpu_instance()->sreg.reg |= 1 << GLOBAL_INTERRUPT_ENABLE;
		break;
		case 7:
			tc1_instance()->timsk.reg |= (1 << OCIE1B) | (1 << TOIE1);
			cpu_instance()->sreg.reg |= 1 << GLOBAL_INTERRUPT_ENABLE;
		break;
		case 8:
			tc1_instance()->timsk.reg |= (1 << TOIE1);
		...
		break;
		case 9:
			tc1_instance()->timsk.reg |= (1 << TICIE1) | (1 << TOIE1);
			cpu_instance()->sreg.reg |= 1 << GLOBAL_INTERRUPT_ENABLE;
		break;
		case 10:
			tc1_instance()->timsk.reg |= (1 << OCIE1A) | (1 << OCIE1B) | (1 << TOIE1);
			cpu_instance()->sreg.reg |= 1 << GLOBAL_INTERRUPT_ENABLE;
		break;
		case 11:
			tc1_instance()->timsk.reg |= (1 << OCIE1A) | (1 << OCIE1B) | (1 << TOIE1);
		...
		break;
		case 12:
			tc1_instance()->timsk.reg |= (1 << OCIE1A) | (1 << OCIE1B);
			tc1_instance()->etimsk.reg |= (1 << OCIE1C);
			cpu_instance()->sreg.reg |= 1 << GLOBAL_INTERRUPT_ENABLE;
		break;
		default:
